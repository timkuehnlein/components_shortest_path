...
public class bellmanFord {
    private static bellmanFord instance = new bellmanFord();

    public static bellmanFord getInstance() {
        return instance;
    }
    // define port
    ...
    public class Port implements IComponent{
        ...
        public Graph.CostPathPair<Integer> getShortestPath(Graph<Integer> graph, Graph.Vertex<Integer> start, Graph.Vertex<Integer> end){
            return theShortestPath(graph,start,end);

        }
        public Map<Graph.Vertex<Integer>, Graph.CostPathPair<Integer>> getShortestPaths(Graph<Integer> graph, Graph.Vertex<Integer> start){
            return theShortestPaths(graph,start);
        }
    }

    public static Map<Graph.Vertex<Integer>, Graph.CostPathPair<Integer>> theShortestPaths(Graph<Integer> graph, Graph.Vertex<Integer> start) {
     ...
     */
    public static Graph.CostPathPair<Integer> theShortestPath(Graph<Integer> graph, Graph.Vertex<Integer> start, Graph.Vertex<Integer> end) {
        if (graph == null)
